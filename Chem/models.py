...
ORGANIC_CLASSES = [
    ...
    ('polyols', 'Многоатомные спирты'),  # Добавлено (9)
    ('polyfunctional_alcohols', 'Полифункциональные спирты'),  # Добавлено (3)
    ('phenols', 'Фенолы'),
    ('ethers', 'Простые эфиры'),
    ('ketals_and_hemiketals', 'Кетали и полукетали'),  # Добавлено (1)
    ('aldehydes', 'Альдегиды'),
    ('polyfunctional_aldehydes', 'Полифункциональные альдегиды'),  # Добавлено (2)
    ('ketones', 'Кетоны'),
    ...
    ('primary_amines', 'Первичные амины'),  # Переименовано из 'amines' (8)
    ('secondary_amines', 'Вторичные амины'),  # Добавлено (6)
    ('tertiary_amines', 'Третичные амины'),  # Добавлено (7)
    ...
    ('other_halogen_derivatives', 'Галогенопроизводные прочих углеводородов'),  # Добавлено (4)
    ('thiols', 'Тиолы'),
    ...
    ('Нитрилы', 'Нитрилы'),  # Изменено (5): Оставляем 'Нитрилы' или 'nitriles' (зависит от вашей БД)
