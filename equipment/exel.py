...
def export_maintenance_schedule_xls(request):
    ...
    equipment_type = 'СИ'
    MODEL = MeasurEquipment.objects.filter(equipment__pointer=request.user.profile.userid).exclude(equipment__status='С').annotate(exnumber=Substr('equipment__exnumber',1,5)).filter(serviceequipmentu_set__year=year_search)
    ...
    equipment_type = 'ИО'
    MODEL = TestingEquipment.objects.filter(equipment__pointer=request.user.profile.userid).exclude(equipment__status='С').annotate(exnumber=Substr('equipment__exnumber',1,5)).filter(serviceequipmentu_set__year=year_search)
    ...
    equipment_type = 'ВО'
    MODEL = HelpingEquipment.objects.filter(equipment__pointer=request.user.profile.userid).exclude(equipment__status='С').annotate(exnumber=Substr('equipment__exnumber',1,5)).filter(serviceequipmentu_set__year=year_search)
